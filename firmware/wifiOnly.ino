...
const char* stationList[TOTAL_STATIONS] = {
  "http://stream.revma.com/bg940511108",                
  "http://icecast.ndr.de/ndr/ndr2/hamburg/mp3/128/stream.mp3", 
  "http://yp.shoutcast.com/sbin/tunein-station.m3u?id=1234"    
};
...
bool isPlaying = true;
int volumePercent = 12; 
int displayVolPercent = 60; 
